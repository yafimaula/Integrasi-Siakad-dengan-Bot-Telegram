    ...
    a.sessionTimeout = function (b) {
        ...
        if ("function" != typeof i.onWarn) {
            ...
            a("body").append('' +
                ...
                '<h4 class="modal-title m-0">' + i.title + '</h4>' +
                ...
                '<button id="session-timeout-dialog-logout" type="button" class="btn btn-warning">' + i.logoutButton + '</button>' +
                '<button id="session-timeout-dialog-keepalive" type="button" class="btn btn-success" data-dismiss="modal">' + i.keepAliveButton + "</button>" +
                "</div>" +
                "</div>" +
                "</div>" +
                "</div>"), a("#session-timeout-dialog-logout").on("click", function () {
